...
print("***GENDER MODEL***")
training_data, test_data, training_classes, test_classes = train_test_split(all_responses_df, full_df['gender'].values, test_size=0.2, random_state=0)

pipe = make_pipeline(StandardScaler(), LinearDiscriminantAnalysis(n_components = 1))

lda_model = pipe.fit(training_data, training_classes)
cross_val_scores = cross_val_score(lda_model, training_data, training_classes)
print("Cross validation scores: ", cross_val_scores)
print("Training score: ", lda_model.score(training_data, training_classes))
print("Test score: ", lda_model.score(test_data, test_classes))

print("\n\n***RACE MODEL***")
training_data, test_data, training_classes, test_classes = train_test_split(all_responses_df, full_df['race'].values, test_size=0.2, random_state=0)
...
print("\n\n***HANDEDNESS MODEL***")
training_data, test_data, training_classes, test_classes = train_test_split(all_responses_df, full_df['hand'].values, test_size=0.2, random_state=0)
...
print("\n\n***COUNTRY MODEL***")
training_data, test_data, training_classes, test_classes = train_test_split(all_responses_df, full_df['country'].values)
...
print("\n\n***AGE MODEL***")
training_data, test_data, training_classes, test_classes = train_test_split(all_responses_df, full_df['age'].values)
